...
# Razonamiento
  ...
  recibe un string
  recorrer el string y por cada simbolo :
  si es apertura lo pusheamos a un arreglo vacio
  si es de cierre lo comparamos con el ultimo de la pila
  si conciden lo sacamos del arreglo apertura
  y si no conciden devolvemos false
  si al final el arreglo es vacio devolver true
  y si no devolvemos false
